...
using forte::EMGMCommandType;
using forte::EMGMResponse;
using forte::SManagementCMD;
using forte::TNameIdentifier;
using forte::iec61499::system::CommandParser;
...
BOOST_AUTO_TEST_CASE(createMissingClosingTagIsInvalidObject) {
  ...
  auto response = parser.parseMGMCommand("", R"(<Request ID="1" Action="CREATE"><FB Name="Trigger" Type="E_CYCLE" />)");
...
BOOST_AUTO_TEST_CASE(deleteFbInstanceHierarchicalName) {
  ...
  auto response =
      parser.parseMGMCommand("", R"(<Request ID="1" Action="DELETE"><FB Name="SubApp1.Trigger" Type="" /></Request>)");
...
BOOST_DATA_TEST_CASE(fbChildIsParsedCorrectly,
  ...
  std::string xml = R"(<Request ID="1" Action=")" + actionName + R"("><FB Name="Trigger" Type="E_CYCLE" /></Request>)";
  auto response = parser.parseMGMCommand("", xml);
...
BOOST_DATA_TEST_CASE(fbChildHierarchicalNameIsSplit, data::make(stateChangeActions), actionName) {
  ...
  std::string xml = R"(<Request ID="1" Action=")" + actionName + R"("><FB Name="SubApp1.Trigger" Type="" /></Request>)";
  auto response = parser.parseMGMCommand("", xml);
...
BOOST_AUTO_TEST_CASE(readConnectionEmptySourceIsBadParams) {
  ...
  auto response =
      parser.parseMGMCommand("", R"(<Request ID="1" Action="READ"><Connection Source="" Destination="*" /></Request>)");
...
BOOST_AUTO_TEST_CASE(queryFbHierarchicalName) {
  ...
  auto response =
      parser.parseMGMCommand("", R"(<Request ID="1" Action="QUERY"><FB Name="SubApp1.Trigger" Type="*" /></Request>)");
...
BOOST_AUTO_TEST_CASE(mismatchedClosingTagIsInvalidObject) {
  ...
  auto response =
      parser.parseMGMCommand("", R"(<Request ID="1" Action="CREATE"><FB Name="Trigger" Type="E_CYCLE" /></Response>)");
...
BOOST_AUTO_TEST_CASE(wrongRootTagIsInvalidObject) {
  ...
  auto response =
      parser.parseMGMCommand("", R"(<Response ID="1" Action="CREATE"><FB Name="Trigger" Type="E_CYCLE" /></Response>)");
