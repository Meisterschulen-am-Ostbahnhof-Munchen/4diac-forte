...
namespace forte::test {
  ...
  BOOST_AUTO_TEST_CASE(sub_reals) {
    ...
    BOOST_TEST(static_cast<CIEC_REAL::TValueType>(result) == 10.2f, boost::test_tools::tolerance(1e-6f));
  }
  ...
  BOOST_AUTO_TEST_CASE(sub_lreals) {
    ...
    BOOST_TEST(static_cast<CIEC_LREAL::TValueType>(result) == 10.2, boost::test_tools::tolerance(1e-6));
  }
